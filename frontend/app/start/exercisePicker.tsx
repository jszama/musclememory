...
export default function ExercisePicker({ exercisesPicked, pickMode, setPickMode }: WorkoutCreatorProps) {
    ...
    return (
            <>
                ...
                <section className="exercise-bank mb-4">
